...
\begin{figure}[hbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{results/experiments/helicase/contd}
...
\begin{figure}[hbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{results/experiments/sf3b/contd}
         \caption{Graph-based + Relion}
    \end{subfigure}
...
\begin{figure}[hbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{results/experiments/her2/contd}
         \caption{Graph-based + Relion}
    \end{subfigure}
